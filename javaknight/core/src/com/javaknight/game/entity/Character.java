...
public class Character extends Sprite implements Entity {
    ...
    public Character(Texture texture, PantallaJuego gameScreen){
        super(texture);
    ...
    public void handleInputs(boolean w, boolean s, boolean a, boolean d){
        float velocidadX = 0;
        float velocidadY = 0;
	...
	public void update(PantallaOnline pantallaOnline, boolean wPressed, boolean sPressed, boolean aPressed,
			boolean dPressed) {
